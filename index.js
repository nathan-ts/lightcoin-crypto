...
class Transaction {
  ...
  commit() {
    console.log(`the value is ${this.value} and the balance is ${this.account.balance}`);
    if (this.account.balance + this.value < 0) {
      console.log(`You cannot perform this transaction: insufficient balance (${this.account.balance}).`);
    } else {
